...
interface IIERC777SenderTxData {
    tokensToSend (sender: TSender, operator: TAddress, from: TAddress, to: TAddress, amount: bigint, userData: TBufferLike, operatorData: TBufferLike): Promise<TransactionConfig>
}
