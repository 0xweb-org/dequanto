...
export class GovernorSettings extends ContractBase {
    ...
    extractLogsProposalThresholdSet (tx: TransactionReceipt): ITxLogItem<TLogProposalThresholdSet>[] {
        let abi = this.$getAbiItem('event', 'ProposalThresholdSet');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TLogProposalThresholdSet>[];
    }
    ...
    extractLogsVotingDelaySet (tx: TransactionReceipt): ITxLogItem<TLogVotingDelaySet>[] {
        let abi = this.$getAbiItem('event', 'VotingDelaySet');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TLogVotingDelaySet>[];
    }

    extractLogsVotingPeriodSet (tx: TransactionReceipt): ITxLogItem<TLogVotingPeriodSet>[] {
        let abi = this.$getAbiItem('event', 'VotingPeriodSet');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TLogVotingPeriodSet>[];
    }
    ...
    async getPastLogsProposalThresholdSet (options?: {
        ...
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TLogProposalThresholdSet>[]> {
    ...
    async getPastLogsVotingDelaySet (options?: {
        ...
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TLogVotingDelaySet>[]> {
    ...
    async getPastLogsVotingPeriodSet (options?: {
        ...
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TLogVotingPeriodSet>[]> {
...
interface IGovernorSettingsTxData {
    ...
    setProposalThreshold (sender: TSender, newProposalThreshold: bigint): Promise<TransactionConfig>
    setVotingDelay (sender: TSender, newVotingDelay: bigint): Promise<TransactionConfig>
    setVotingPeriod (sender: TSender, newVotingPeriod: bigint): Promise<TransactionConfig>
}
