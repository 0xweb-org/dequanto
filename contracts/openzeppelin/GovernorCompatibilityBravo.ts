...
interface IGovernorCompatibilityBravoTxData {
    cancel (sender: TSender, proposalId: bigint): Promise<TransactionConfig>
    ...
    execute (sender: TSender, proposalId: bigint): Promise<TransactionConfig>
    ...
    propose (sender: TSender, targets: TAddress[], values: bigint[], signatures: string[], calldatas: TBufferLike[], description: string): Promise<TransactionConfig>
    ...
    queue (sender: TSender, proposalId: bigint): Promise<TransactionConfig>
