...
export class ERC1967Upgrade extends ContractBase {
    ...
    $call () {
        return super.$call() as IERC1967UpgradeTxCaller;;
    }

    $data (): IERC1967UpgradeTxData {
        return super.$data() as IERC1967UpgradeTxData;
    }
...
interface IERC1967UpgradeTxCaller {

}


interface IERC1967UpgradeTxData {
