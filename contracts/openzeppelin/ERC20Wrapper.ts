...
interface IERC20WrapperTxData {
    ...
    depositFor (sender: TSender, account: TAddress, amount: bigint): Promise<TransactionConfig>
    ...
    withdrawTo (sender: TSender, account: TAddress, amount: bigint): Promise<TransactionConfig>
}
