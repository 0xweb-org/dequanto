...
export class ERC20 extends ContractBase {
    ...
    $meta = {
        "class": "./contracts/openzeppelin/ERC20.ts"
    }
    ...
    $call () {
        return super.$call() as IERC20TxCaller;
    }
    $signed (): TOverrideReturns<IERC20TxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC20TxData {
        return super.$data() as IERC20TxData;
    }
    $gas (): TOverrideReturns<IERC20TxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC20Types['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC20Types['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
type TEvents = TERC20Types['Events'];
