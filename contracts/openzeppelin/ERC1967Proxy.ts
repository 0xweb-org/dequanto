...
export class ERC1967Proxy extends ContractBase {
    ...
    $call () {
        return super.$call() as IERC1967ProxyTxCaller;;
    }

    $data (): IERC1967ProxyTxData {
        return super.$data() as IERC1967ProxyTxData;
    }
...
interface IERC1967ProxyTxCaller {

}


interface IERC1967ProxyTxData {
