...
export class ERC1155Burnable extends ContractBase {
    constructor(
    ...
    $call () {
        return super.$call() as IERC1155BurnableTxCaller;;
    }

    $data (): IERC1155BurnableTxData {
        return super.$data() as IERC1155BurnableTxData;
    }
...
interface IERC1155BurnableTxCaller {
...
interface IERC1155BurnableTxData {
    burn (sender: TSender, account: TAddress, id: bigint, value: bigint): Promise<TransactionConfig>
    burnBatch (sender: TSender, account: TAddress, ids: bigint[], values: bigint[]): Promise<TransactionConfig>
