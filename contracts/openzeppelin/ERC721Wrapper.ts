...
export class ERC721Wrapper extends ContractBase {
    ...
    // 0x150b7a02
    async onERC721Received (sender: TSender, input0: TAddress, from: TAddress, tokenId: bigint, input3: TBufferLike): Promise<TxWriter> {
...
interface IMethodOnERC721Received {
  ...
  arguments: [ input0: TAddress, from: TAddress, tokenId: bigint, input3: TBufferLike ]
}
...
interface IERC721WrapperTxCaller {
    ...
    onERC721Received (sender: TSender, input0: TAddress, from: TAddress, tokenId: bigint, input3: TBufferLike): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
...
interface IERC721WrapperTxData {
    ...
    onERC721Received (sender: TSender, input0: TAddress, from: TAddress, tokenId: bigint, input3: TBufferLike): Promise<TEth.TxLike>
