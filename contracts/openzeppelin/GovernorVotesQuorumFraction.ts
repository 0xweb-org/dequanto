...
export class GovernorVotesQuorumFraction extends ContractBase {
    ...
    onQuorumNumeratorUpdated (fn: (event: EventLog, oldQuorumNumerator: bigint, newQuorumNumerator: bigint) => void): ClientEventsStream<any> {
        return this.$on('QuorumNumeratorUpdated', fn);
    }
