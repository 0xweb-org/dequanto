...
export class GovernorVotesQuorumFraction extends ContractBase {
    ...
    onQuorumNumeratorUpdated (fn?: (event: TClientEventsStreamData<TLogQuorumNumeratorUpdatedParameters>) => void): ClientEventsStream<TClientEventsStreamData<TLogQuorumNumeratorUpdatedParameters>> {
