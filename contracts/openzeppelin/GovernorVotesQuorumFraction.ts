...
export class GovernorVotesQuorumFraction extends ContractBase {
    ...
    async quorumNumerator (): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'quorumNumerator'));
    }
    ...
    extractLogsQuorumNumeratorUpdated (tx: TransactionReceipt): ITxLogItem<TLogQuorumNumeratorUpdated>[] {
...
interface IGovernorVotesQuorumFractionTxData {
    ...
    updateQuorumNumerator (sender: TSender, newQuorumNumerator: bigint): Promise<TransactionConfig>
}
