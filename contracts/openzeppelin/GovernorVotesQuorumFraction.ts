...
export class GovernorVotesQuorumFraction extends ContractBase {
    ...
    extractLogsQuorumNumeratorUpdated (tx: TEth.TxReceipt): ITxLogItem<TLogQuorumNumeratorUpdated>[] {
        let abi = this.$getAbiItem('event', 'QuorumNumeratorUpdated');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TLogQuorumNumeratorUpdated>[];
    }
    ...
    async getPastLogsQuorumNumeratorUpdated (options?: {
        ...
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TLogQuorumNumeratorUpdated>[]> {
...
type TSender = TAccount & {
    ...
    type TLogQuorumNumeratorUpdated = {
        oldQuorumNumerator: bigint, newQuorumNumerator: bigint
    };
    type TLogQuorumNumeratorUpdatedParameters = [ oldQuorumNumerator: bigint, newQuorumNumerator: bigint ];
    type TLogVoteCast = {
...
interface IEvents {
  ...
  QuorumNumeratorUpdated: TLogQuorumNumeratorUpdatedParameters
...
interface IMethodQuorumDenominator {
  method: "quorumDenominator"
  arguments: [  ]
}

interface IMethodQuorumNumerator {
...
interface IMethodUpdateQuorumNumerator {
...
interface IMethods {
  ...
  quorumDenominator: IMethodQuorumDenominator
  quorumNumerator: IMethodQuorumNumerator
  relay: IMethodRelay
  state: IMethodState
  supportsInterface: IMethodSupportsInterface
  token: IMethodToken
  updateQuorumNumerator: IMethodUpdateQuorumNumerator
