...
export class GovernorPreventLateQuorum extends ContractBase {
    ...
    extractLogsLateQuorumVoteExtensionSet (tx: TransactionReceipt): ITxLogItem<TLogLateQuorumVoteExtensionSet>[] {
    ...
    extractLogsProposalExtended (tx: TransactionReceipt): ITxLogItem<TLogProposalExtended>[] {
...
interface IGovernorPreventLateQuorumTxData {
    ...
    setLateQuorumVoteExtension (sender: TSender, newVoteExtension: number): Promise<TransactionConfig>
}
