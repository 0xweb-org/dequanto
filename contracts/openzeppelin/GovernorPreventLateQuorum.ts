...
export class GovernorPreventLateQuorum extends ContractBase {
    ...
    onLateQuorumVoteExtensionSet (fn?: (event: TClientEventsStreamData<TLogLateQuorumVoteExtensionSetParameters>) => void): ClientEventsStream<TClientEventsStreamData<TLogLateQuorumVoteExtensionSetParameters>> {
    ...
    onProposalExtended (fn?: (event: TClientEventsStreamData<TLogProposalExtendedParameters>) => void): ClientEventsStream<TClientEventsStreamData<TLogProposalExtendedParameters>> {
    ...
    extractLogsLateQuorumVoteExtensionSet (tx: TEth.TxReceipt): ITxLogItem<TLogLateQuorumVoteExtensionSet>[] {
        let abi = this.$getAbiItem('event', 'LateQuorumVoteExtensionSet');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TLogLateQuorumVoteExtensionSet>[];
    }
    ...
    extractLogsProposalExtended (tx: TEth.TxReceipt): ITxLogItem<TLogProposalExtended>[] {
        let abi = this.$getAbiItem('event', 'ProposalExtended');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TLogProposalExtended>[];
    }
    ...
    async getPastLogsLateQuorumVoteExtensionSet (options?: {
        ...
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TLogLateQuorumVoteExtensionSet>[]> {
    ...
    }): Promise<ITxLogItem<TLogProposalExtended>[]> {
...
type TSender = TAccount & {
    ...
    type TLogLateQuorumVoteExtensionSet = {
        oldVoteExtension: number, newVoteExtension: number
    };
    type TLogLateQuorumVoteExtensionSetParameters = [ oldVoteExtension: number, newVoteExtension: number ];
    ...
    type TLogProposalExtended = {
        proposalId: bigint, extendedDeadline: number
    };
    type TLogProposalExtendedParameters = [ proposalId: bigint, extendedDeadline: number ];
    type TLogVoteCast = {
...
interface IEvents {
  ...
  LateQuorumVoteExtensionSet: TLogLateQuorumVoteExtensionSetParameters
  ...
  ProposalExtended: TLogProposalExtendedParameters
...
interface IMethodLateQuorumVoteExtension {
...
interface IMethodSetLateQuorumVoteExtension {
...
interface IMethods {
  ...
  lateQuorumVoteExtension: IMethodLateQuorumVoteExtension
  name: IMethodName
  ...
  relay: IMethodRelay
  setLateQuorumVoteExtension: IMethodSetLateQuorumVoteExtension
  state: IMethodState
