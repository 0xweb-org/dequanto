...
export class GovernorPreventLateQuorum extends ContractBase {
    ...
    onLateQuorumVoteExtensionSet (fn: (event: EventLog, oldVoteExtension: number, newVoteExtension: number) => void): ClientEventsStream<any> {
        return this.$on('LateQuorumVoteExtensionSet', fn);
    }
    ...
    onProposalExtended (fn: (event: EventLog, proposalId: bigint, extendedDeadline: number) => void): ClientEventsStream<any> {
        return this.$on('ProposalExtended', fn);
    }
