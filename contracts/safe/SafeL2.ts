...
export class SafeL2 extends ContractBase {
    ...
    $meta = {
    "class": "./contracts/safe/SafeL2.ts"
}
...
type TSender = TAccount & {
    ...
    type TLogSafeModuleTransaction = {
        module: TAddress, to: TAddress, value: bigint, data: TEth.Hex, operation: number
    };
    type TLogSafeModuleTransactionParameters = [ module: TAddress, to: TAddress, value: bigint, data: TEth.Hex, operation: number ];
    type TLogSafeMultiSigTransaction = {
        to: TAddress, value: bigint, data: TEth.Hex, operation: number, safeTxGas: bigint, baseGas: bigint, gasPrice: bigint, gasToken: TAddress, refundReceiver: TAddress, signatures: TEth.Hex, additionalInfo: TEth.Hex
    };
    type TLogSafeMultiSigTransactionParameters = [ to: TAddress, value: bigint, data: TEth.Hex, operation: number, safeTxGas: bigint, baseGas: bigint, gasPrice: bigint, gasToken: TAddress, refundReceiver: TAddress, signatures: TEth.Hex, additionalInfo: TEth.Hex ];
