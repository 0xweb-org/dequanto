...
export class AmmPairV2Contract extends ContractBase {
    ...
    // 0x022c0d9f
    async swap (sender: TSender, amount0Out: bigint, amount1Out: bigint, to: TAddress, data: TBufferLike): Promise<TxWriter> {
    ...
    storage: AmmPairV2ContractStorageReader
}
...
interface IMethodSwap {
  method: "swap"
  arguments: [ amount0Out: bigint, amount1Out: bigint, to: TAddress, data: TBufferLike ]
}
...
interface IAmmPairV2ContractTxCaller {
    ...
    swap (sender: TSender, amount0Out: bigint, amount1Out: bigint, to: TAddress, data: TBufferLike): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
...
interface IAmmPairV2ContractTxData {
    ...
    swap (sender: TSender, amount0Out: bigint, amount1Out: bigint, to: TAddress, data: TBufferLike): Promise<TEth.TxLike>
