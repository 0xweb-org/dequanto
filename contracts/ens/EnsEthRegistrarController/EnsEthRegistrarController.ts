...
export class EnsEthRegistrarController extends ContractBase {
    ...
    // 0xf14fcbc8
    async commit (sender: TSender, commitment: TBufferLike): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'commit'), sender, commitment);
    }

    // 0x839df945
    async commitments (input0: TBufferLike): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'commitments'), input0);
    }

    // 0x65a69dcf
    async makeCommitment (name: string, owner: TAddress, duration: bigint, secret: TBufferLike, resolver: TAddress, data: TBufferLike[], reverseRecord: boolean, ownerControlledFuses: number): Promise<TBufferLike> {
    ...
    // 0x74694a2b
    async register (sender: TSender, name: string, owner: TAddress, duration: bigint, secret: TBufferLike, resolver: TAddress, data: TBufferLike[], reverseRecord: boolean, ownerControlledFuses: number): Promise<TxWriter> {
    ...
    storage: EnsEthRegistrarControllerStorageReader
}
...
type TSender = TAccount & {
    ...
    type TLogNameRegistered = {
        name: string, label: TBufferLike, owner: TAddress, baseCost: bigint, premium: bigint, expires: bigint
    };
    type TLogNameRegisteredParameters = [ name: string, label: TBufferLike, owner: TAddress, baseCost: bigint, premium: bigint, expires: bigint ];
    type TLogNameRenewed = {
        name: string, label: TBufferLike, cost: bigint, expires: bigint
    };
    type TLogNameRenewedParameters = [ name: string, label: TBufferLike, cost: bigint, expires: bigint ];
...
interface IMethodCommit {
  method: "commit"
  arguments: [ commitment: TBufferLike ]
}
...
interface IMethodMakeCommitment {
  ...
  arguments: [ name: string, owner: TAddress, duration: bigint, secret: TBufferLike, resolver: TAddress, data: TBufferLike[], reverseRecord: boolean, ownerControlledFuses: number ]
}
...
class EnsEthRegistrarControllerStorageReader extends ContractStorageReaderBase {
    ...
    async commitments(key: TBufferLike): Promise<bigint> {
...
interface IEnsEthRegistrarControllerTxCaller {
    commit (sender: TSender, commitment: TBufferLike): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
    ...
    register (sender: TSender, name: string, owner: TAddress, duration: bigint, secret: TBufferLike, resolver: TAddress, data: TBufferLike[], reverseRecord: boolean, ownerControlledFuses: number): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
...
interface IEnsEthRegistrarControllerTxData {
    commit (sender: TSender, commitment: TBufferLike): Promise<TEth.TxLike>
    recoverFunds (sender: TSender, _token: TAddress, _to: TAddress, _amount: bigint): Promise<TEth.TxLike>
    register (sender: TSender, name: string, owner: TAddress, duration: bigint, secret: TBufferLike, resolver: TAddress, data: TBufferLike[], reverseRecord: boolean, ownerControlledFuses: number): Promise<TEth.TxLike>
