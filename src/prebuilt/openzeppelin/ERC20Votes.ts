...
export class ERC20Votes extends ContractBase {
    ...
    Types: TERC20VotesTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC20Votes.ts"
    }
    ...
    onTransaction <TMethod extends keyof TERC20VotesTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC20VotesTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
type TEvents = TERC20VotesTypes['Events'];
