...
export class ERC1155Receiver extends ContractBase {
    ...
    Types: TERC1155ReceiverTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC1155Receiver.ts"
    }
    ...
    $signed (): TOverrideReturns<IERC1155ReceiverTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC1155ReceiverTxData {
        return super.$data() as IERC1155ReceiverTxData;
    }
    $gas (): TOverrideReturns<IERC1155ReceiverTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
