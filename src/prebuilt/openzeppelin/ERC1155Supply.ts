...
export class ERC1155Supply extends ContractBase {
    ...
    Types: TERC1155SupplyTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC1155Supply.ts"
    }
    ...
    async exists (id: bigint): Promise<boolean> {
        return this.$read(this.$getAbiItem('function', 'exists'), id);
    }
    ...
    async totalSupply (id: bigint): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'totalSupply'), id);
    }
    ...
    $call () {
        return super.$call() as IERC1155SupplyTxCaller;
    }
    $signed (): TOverrideReturns<IERC1155SupplyTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC1155SupplyTxData {
        return super.$data() as IERC1155SupplyTxData;
    }
    $gas (): TOverrideReturns<IERC1155SupplyTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC1155SupplyTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC1155SupplyTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC1155SupplyTypes = {
    Events: {
        ApprovalForAll: {
...
interface IERC1155SupplyTxCaller {
...
interface IERC1155SupplyTxData {
...
type TEvents = TERC1155SupplyTypes['Events'];
