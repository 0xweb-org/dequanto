...
export class ERC1155Burnable extends ContractBase {
    ...
    Types: TERC1155BurnableTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC1155Burnable.ts"
    }
    ...
    $signed (): TOverrideReturns<IERC1155BurnableTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC1155BurnableTxData {
        return super.$data() as IERC1155BurnableTxData;
    }
    $gas (): TOverrideReturns<IERC1155BurnableTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
