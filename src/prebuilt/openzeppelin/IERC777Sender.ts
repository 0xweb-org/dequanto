...
export class IERC777Sender extends ContractBase {
    ...
    Types: TIERC777SenderTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/IERC777Sender.ts"
    }
    ...
    onTransaction <TMethod extends keyof TIERC777SenderTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TIERC777SenderTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TIERC777SenderTypes = {
    Events: {
...
type TEvents = TIERC777SenderTypes['Events'];
