...
export class IERC20Metadata extends ContractBase {
    ...
    Types: TIERC20MetadataTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/IERC20Metadata.ts"
    }
    ...
    $call () {
        return super.$call() as IIERC20MetadataTxCaller;
    }
    $signed (): TOverrideReturns<IIERC20MetadataTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IIERC20MetadataTxData {
        return super.$data() as IIERC20MetadataTxData;
    }
    $gas (): TOverrideReturns<IIERC20MetadataTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TIERC20MetadataTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TIERC20MetadataTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TIERC20MetadataTypes = {
    Events: {
        Approval: {
...
interface IIERC20MetadataTxCaller {
...
type TEvents = TIERC20MetadataTypes['Events'];
