...
export namespace GovernorVotesQuorumFractionErrors {
...
export class GovernorVotesQuorumFraction extends ContractBase {
    constructor(
    ...
    Types: TGovernorVotesQuorumFractionTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/GovernorVotesQuorumFraction.ts"
    }
    ...
    // 0x97c3d334
    async quorumDenominator (): Promise<bigint> {
        return this.$read(this.$getAbiItem('function', 'quorumDenominator'));
    }

    // 0x60c4247f
    async quorumNumerator (timepoint: bigint): Promise<bigint>
    // 0xa7713a70
    async quorumNumerator (): Promise<bigint>
    async quorumNumerator (...args): Promise<bigint> {
        let abi = this.$getAbiItemOverload([ 'function quorumNumerator(uint256) returns uint256', 'function quorumNumerator() returns uint256' ], args);
    ...
    // 0x06f3f9e6
    async updateQuorumNumerator (sender: TSender, newQuorumNumerator: bigint): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'updateQuorumNumerator'), sender, newQuorumNumerator);
    }
    ...
    $call () {
        return super.$call() as IGovernorVotesQuorumFractionTxCaller;
    }
    $signed (): TOverrideReturns<IGovernorVotesQuorumFractionTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IGovernorVotesQuorumFractionTxData {
        return super.$data() as IGovernorVotesQuorumFractionTxData;
    }
    $gas (): TOverrideReturns<IGovernorVotesQuorumFractionTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TGovernorVotesQuorumFractionTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TGovernorVotesQuorumFractionTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    onQuorumNumeratorUpdated (fn?: (event: TClientEventsStreamData<TEventArguments<'QuorumNumeratorUpdated'>>) => void): ClientEventsStream<TClientEventsStreamData<TEventArguments<'QuorumNumeratorUpdated'>>> {
        return this.$onLog('QuorumNumeratorUpdated', fn);
    }
    ...
    extractLogsQuorumNumeratorUpdated (tx: TEth.TxReceipt): ITxLogItem<TEventParams<'QuorumNumeratorUpdated'>>[] {
        let abi = this.$getAbiItem('event', 'QuorumNumeratorUpdated');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TEventParams<'QuorumNumeratorUpdated'>>[];
    }
    ...
    async getPastLogsQuorumNumeratorUpdated (options?: {
        fromBlock?: number | Date
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TEventParams<'QuorumNumeratorUpdated'>>[]> {
        return await this.$getPastLogsParsed('QuorumNumeratorUpdated', options) as any;
    }
...
export type TGovernorVotesQuorumFractionTypes = {
    Events: {
        EIP712DomainChanged: {
            outputParams: {  },
            outputArgs:   [  ],
        ...
        QuorumNumeratorUpdated: {
            outputParams: { oldQuorumNumerator: bigint, newQuorumNumerator: bigint },
            outputArgs:   [ oldQuorumNumerator: bigint, newQuorumNumerator: bigint ],
        }
        VoteCast: {
    ...
    Methods: {
        ...
        updateQuorumNumerator: {
          ...
          arguments: [ newQuorumNumerator: bigint ]
        }
        version: {
          method: "version"
          arguments: [  ]
...
interface IGovernorVotesQuorumFractionTxCaller {
    ...
    updateQuorumNumerator (sender: TSender, newQuorumNumerator: bigint): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
}


interface IGovernorVotesQuorumFractionTxData {
    ...
    updateQuorumNumerator (sender: TSender, newQuorumNumerator: bigint): Promise<TEth.TxLike>
}


type TEvents = TGovernorVotesQuorumFractionTypes['Events'];
