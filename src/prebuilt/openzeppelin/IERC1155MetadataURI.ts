...
export class IERC1155MetadataURI extends ContractBase {
    constructor(
    ...
    Types: TIERC1155MetadataURITypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/IERC1155MetadataURI.ts"
    }
    ...
    async uri (id: bigint): Promise<string> {
        return this.$read(this.$getAbiItem('function', 'uri'), id);
    }

    $call () {
        return super.$call() as IIERC1155MetadataURITxCaller;
    }
    $signed (): TOverrideReturns<IIERC1155MetadataURITxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IIERC1155MetadataURITxData {
        return super.$data() as IIERC1155MetadataURITxData;
    }
    $gas (): TOverrideReturns<IIERC1155MetadataURITxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TIERC1155MetadataURITypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TIERC1155MetadataURITypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TIERC1155MetadataURITypes = {
    Events: {
        ApprovalForAll: {
...
interface IIERC1155MetadataURITxCaller {
...
interface IIERC1155MetadataURITxData {
...
type TEvents = TIERC1155MetadataURITypes['Events'];
