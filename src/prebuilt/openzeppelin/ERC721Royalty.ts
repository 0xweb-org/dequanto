...
export class ERC721Royalty extends ContractBase {
    ...
    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC721Royalty.ts"
    }
    ...
    $call () {
        return super.$call() as IERC721RoyaltyTxCaller;
    }
    $signed (): TOverrideReturns<IERC721RoyaltyTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC721RoyaltyTxData {
        return super.$data() as IERC721RoyaltyTxData;
    }
    $gas (): TOverrideReturns<IERC721RoyaltyTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC721RoyaltyTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC721RoyaltyTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC721RoyaltyTypes = {
    Events: {
        Approval: {
...
interface IERC721RoyaltyTxCaller {
...
interface IERC721RoyaltyTxData {
