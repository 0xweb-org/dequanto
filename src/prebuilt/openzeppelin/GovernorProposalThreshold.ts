...
export class GovernorProposalThreshold extends ContractBase {
    constructor(
    ...
    Types: TGovernorProposalThresholdTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/GovernorProposalThreshold.ts"
    }
    ...
    $call () {
        return super.$call() as IGovernorProposalThresholdTxCaller;
    }
    $signed (): TOverrideReturns<IGovernorProposalThresholdTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IGovernorProposalThresholdTxData {
        return super.$data() as IGovernorProposalThresholdTxData;
    }
    $gas (): TOverrideReturns<IGovernorProposalThresholdTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TGovernorProposalThresholdTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TGovernorProposalThresholdTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TGovernorProposalThresholdTypes = {
    Events: {
        EIP712DomainChanged: {
            outputParams: {  },
            outputArgs:   [  ],
...
interface IGovernorProposalThresholdTxCaller {
...
interface IGovernorProposalThresholdTxData {
...
type TEvents = TGovernorProposalThresholdTypes['Events'];
