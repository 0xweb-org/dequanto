...
export namespace GovernorErrors {
...
export class Governor extends ContractBase {
    ...
    Types: TGovernorTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/Governor.ts"
    }
    ...
    $call () {
        return super.$call() as IGovernorTxCaller;
    }
    $signed (): TOverrideReturns<IGovernorTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IGovernorTxData {
        return super.$data() as IGovernorTxData;
    }
    $gas (): TOverrideReturns<IGovernorTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TGovernorTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TGovernorTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
type TEvents = TGovernorTypes['Events'];
