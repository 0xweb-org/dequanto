...
export class ERC721Burnable extends ContractBase {
    constructor(
    ...
    Types: TERC721BurnableTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC721Burnable.ts"
    }
    ...
    $call () {
        return super.$call() as IERC721BurnableTxCaller;
    }
    $signed (): TOverrideReturns<IERC721BurnableTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC721BurnableTxData {
        return super.$data() as IERC721BurnableTxData;
    }
    $gas (): TOverrideReturns<IERC721BurnableTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC721BurnableTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC721BurnableTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC721BurnableTypes = {
    Events: {
        Approval: {
...
interface IERC721BurnableTxCaller {
...
interface IERC721BurnableTxData {
...
type TEvents = TERC721BurnableTypes['Events'];
