...
export class ERC1155Pausable extends ContractBase {
    ...
    Types: TERC1155PausableTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC1155Pausable.ts"
    }
    ...
    $signed (): TOverrideReturns<IERC1155PausableTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC1155PausableTxData {
        return super.$data() as IERC1155PausableTxData;
    }
    $gas (): TOverrideReturns<IERC1155PausableTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC1155PausableTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC1155PausableTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC1155PausableTypes = {
    Events: {
        ApprovalForAll: {
...
type TEvents = TERC1155PausableTypes['Events'];
