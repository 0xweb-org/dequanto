...
export class ERC20Burnable extends ContractBase {
    constructor(
    ...
    Types: TERC20BurnableTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC20Burnable.ts"
    }
    ...
    $call () {
        return super.$call() as IERC20BurnableTxCaller;
    }
    $signed (): TOverrideReturns<IERC20BurnableTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC20BurnableTxData {
        return super.$data() as IERC20BurnableTxData;
    }
    $gas (): TOverrideReturns<IERC20BurnableTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC20BurnableTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC20BurnableTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC20BurnableTypes = {
    Events: {
        Approval: {
...
interface IERC20BurnableTxCaller {
...
interface IERC20BurnableTxData {
...
type TEvents = TERC20BurnableTypes['Events'];
