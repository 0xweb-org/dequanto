...
export class ERC20FlashMint extends ContractBase {
    ...
    Types: TERC20FlashMintTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC20FlashMint.ts"
    }
    ...
    onTransaction <TMethod extends keyof TERC20FlashMintTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC20FlashMintTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC20FlashMintTypes = {
    Events: {
        Approval: {
...
type TEvents = TERC20FlashMintTypes['Events'];
