...
export namespace GovernorCountingSimpleErrors {
...
export class GovernorCountingSimple extends ContractBase {
    constructor(
    ...
    Types: TGovernorCountingSimpleTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/GovernorCountingSimple.ts"
    }
    ...
    // 0x544ffc9c
    async proposalVotes (proposalId: bigint): Promise<{ againstVotes: bigint, forVotes: bigint, abstainVotes: bigint }> {
        return this.$read(this.$getAbiItem('function', 'proposalVotes'), proposalId);
    }
    ...
    $call () {
        return super.$call() as IGovernorCountingSimpleTxCaller;
    }
    $signed (): TOverrideReturns<IGovernorCountingSimpleTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IGovernorCountingSimpleTxData {
        return super.$data() as IGovernorCountingSimpleTxData;
    }
    $gas (): TOverrideReturns<IGovernorCountingSimpleTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TGovernorCountingSimpleTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TGovernorCountingSimpleTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TGovernorCountingSimpleTypes = {
    Events: {
        EIP712DomainChanged: {
            outputParams: {  },
            outputArgs:   [  ],
...
interface IGovernorCountingSimpleTxCaller {
...
interface IGovernorCountingSimpleTxData {
...
type TEvents = TGovernorCountingSimpleTypes['Events'];
