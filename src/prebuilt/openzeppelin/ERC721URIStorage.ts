...
export class ERC721URIStorage extends ContractBase {
    ...
    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC721URIStorage.ts"
    }
    ...
    $call () {
        return super.$call() as IERC721URIStorageTxCaller;
    }
    $signed (): TOverrideReturns<IERC721URIStorageTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC721URIStorageTxData {
        return super.$data() as IERC721URIStorageTxData;
    }
    $gas (): TOverrideReturns<IERC721URIStorageTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
...
interface IERC721URIStorageTxCaller {
