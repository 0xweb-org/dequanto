...
export class ERC1155Holder extends ContractBase {
    ...
    Types: TERC1155HolderTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC1155Holder.ts"
    }
    ...
    $signed (): TOverrideReturns<IERC1155HolderTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
    ...
    onTransaction <TMethod extends keyof TERC1155HolderTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC1155HolderTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC1155HolderTypes = {
    Events: {
...
type TEvents = TERC1155HolderTypes['Events'];
