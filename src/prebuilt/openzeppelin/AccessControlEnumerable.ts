...
export class AccessControlEnumerable extends ContractBase {
    constructor(
    ...
    Types: TAccessControlEnumerableTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/AccessControlEnumerable.ts"
    }
    ...
    $call () {
        return super.$call() as IAccessControlEnumerableTxCaller;
    }
    $signed (): TOverrideReturns<IAccessControlEnumerableTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IAccessControlEnumerableTxData {
        return super.$data() as IAccessControlEnumerableTxData;
    }
    $gas (): TOverrideReturns<IAccessControlEnumerableTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TAccessControlEnumerableTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TAccessControlEnumerableTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TAccessControlEnumerableTypes = {
    Events: {
        RoleAdminChanged: {
...
interface IAccessControlEnumerableTxCaller {
...
interface IAccessControlEnumerableTxData {
...
type TEvents = TAccessControlEnumerableTypes['Events'];
