...
export class ERC20PresetFixedSupply extends ContractBase {
    constructor(
    ...
    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC20PresetFixedSupply.ts"
    }

    async $constructor (deployer: TSender, name: string, symbol: string, initialSupply: bigint, owner: TAddress): Promise<TxWriter> {
    ...
    $call () {
        return super.$call() as IERC20PresetFixedSupplyTxCaller;
    }
    $signed (): TOverrideReturns<IERC20PresetFixedSupplyTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC20PresetFixedSupplyTxData {
        return super.$data() as IERC20PresetFixedSupplyTxData;
    }
    $gas (): TOverrideReturns<IERC20PresetFixedSupplyTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC20PresetFixedSupplyTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC20PresetFixedSupplyTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC20PresetFixedSupplyTypes = {
    Events: {
        Approval: {
...
interface IERC20PresetFixedSupplyTxCaller {
...
interface IERC20PresetFixedSupplyTxData {
