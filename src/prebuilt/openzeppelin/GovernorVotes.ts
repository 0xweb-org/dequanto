...
export namespace GovernorVotesErrors {
...
export class GovernorVotes extends ContractBase {
    constructor(
    ...
    Types: TGovernorVotesTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/GovernorVotes.ts"
    }
    ...
    $call () {
        return super.$call() as IGovernorVotesTxCaller;
    }
    $signed (): TOverrideReturns<IGovernorVotesTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IGovernorVotesTxData {
        return super.$data() as IGovernorVotesTxData;
    }
    $gas (): TOverrideReturns<IGovernorVotesTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
...
interface IGovernorVotesTxCaller {
...
interface IGovernorVotesTxData {
