...
export namespace GovernorPreventLateQuorumErrors {
...
export class GovernorPreventLateQuorum extends ContractBase {
    constructor(
    ...
    Types: TGovernorPreventLateQuorumTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/GovernorPreventLateQuorum.ts"
    }
    ...
    // 0x32b8113e
    async lateQuorumVoteExtension (): Promise<number> {
        return this.$read(this.$getAbiItem('function', 'lateQuorumVoteExtension'));
    }
    ...
    // 0xd07f91e9
    async setLateQuorumVoteExtension (sender: TSender, newVoteExtension: number): Promise<TxWriter> {
        return this.$write(this.$getAbiItem('function', 'setLateQuorumVoteExtension'), sender, newVoteExtension);
    }
    ...
    $call () {
        return super.$call() as IGovernorPreventLateQuorumTxCaller;
    }
    $signed (): TOverrideReturns<IGovernorPreventLateQuorumTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IGovernorPreventLateQuorumTxData {
        return super.$data() as IGovernorPreventLateQuorumTxData;
    }
    $gas (): TOverrideReturns<IGovernorPreventLateQuorumTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TGovernorPreventLateQuorumTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TGovernorPreventLateQuorumTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
    ...
    onLateQuorumVoteExtensionSet (fn?: (event: TClientEventsStreamData<TEventArguments<'LateQuorumVoteExtensionSet'>>) => void): ClientEventsStream<TClientEventsStreamData<TEventArguments<'LateQuorumVoteExtensionSet'>>> {
        return this.$onLog('LateQuorumVoteExtensionSet', fn);
    }
    ...
    onProposalExtended (fn?: (event: TClientEventsStreamData<TEventArguments<'ProposalExtended'>>) => void): ClientEventsStream<TClientEventsStreamData<TEventArguments<'ProposalExtended'>>> {
        return this.$onLog('ProposalExtended', fn);
    }
    ...
    extractLogsLateQuorumVoteExtensionSet (tx: TEth.TxReceipt): ITxLogItem<TEventParams<'LateQuorumVoteExtensionSet'>>[] {
        let abi = this.$getAbiItem('event', 'LateQuorumVoteExtensionSet');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TEventParams<'LateQuorumVoteExtensionSet'>>[];
    }
    ...
    extractLogsProposalExtended (tx: TEth.TxReceipt): ITxLogItem<TEventParams<'ProposalExtended'>>[] {
        let abi = this.$getAbiItem('event', 'ProposalExtended');
        return this.$extractLogs(tx, abi) as any as ITxLogItem<TEventParams<'ProposalExtended'>>[];
    }
    ...
    async getPastLogsLateQuorumVoteExtensionSet (options?: {
        fromBlock?: number | Date
        toBlock?: number | Date
        params?: {  }
    }): Promise<ITxLogItem<TEventParams<'LateQuorumVoteExtensionSet'>>[]> {
        return await this.$getPastLogsParsed('LateQuorumVoteExtensionSet', options) as any;
    }
    ...
    async getPastLogsProposalExtended (options?: {
        fromBlock?: number | Date
        toBlock?: number | Date
        params?: { proposalId?: bigint }
    }): Promise<ITxLogItem<TEventParams<'ProposalExtended'>>[]> {
        return await this.$getPastLogsParsed('ProposalExtended', options) as any;
    }
...
export type TGovernorPreventLateQuorumTypes = {
    Events: {
        EIP712DomainChanged: {
            outputParams: {  },
            outputArgs:   [  ],
        ...
        LateQuorumVoteExtensionSet: {
            outputParams: { oldVoteExtension: number, newVoteExtension: number },
            outputArgs:   [ oldVoteExtension: number, newVoteExtension: number ],
        }
        ProposalCanceled: {
        ...
        ProposalExtended: {
            outputParams: { proposalId: bigint, extendedDeadline: number },
            outputArgs:   [ proposalId: bigint, extendedDeadline: number ],
        }
        VoteCast: {
    ...
    Methods: {
        ...
        lateQuorumVoteExtension: {
          method: "lateQuorumVoteExtension"
          arguments: [  ]
        }
        name: {
          method: "name"
        ...
        setLateQuorumVoteExtension: {
          method: "setLateQuorumVoteExtension"
          arguments: [ newVoteExtension: number ]
        }
        state: {
          method: "state"
          arguments: [ proposalId: bigint ]
...
interface IGovernorPreventLateQuorumTxCaller {
    ...
    setLateQuorumVoteExtension (sender: TSender, newVoteExtension: number): Promise<{ error?: Error & { data?: { type: string, params } }, result? }>
}


interface IGovernorPreventLateQuorumTxData {
    ...
    setLateQuorumVoteExtension (sender: TSender, newVoteExtension: number): Promise<TEth.TxLike>
}


type TEvents = TGovernorPreventLateQuorumTypes['Events'];
