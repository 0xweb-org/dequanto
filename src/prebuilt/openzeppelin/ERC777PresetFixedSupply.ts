...
export class ERC777PresetFixedSupply extends ContractBase {
    ...
    Types: TERC777PresetFixedSupplyTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/ERC777PresetFixedSupply.ts"
    }

    async $constructor (deployer: TSender, name: string, symbol: string, defaultOperators: TAddress[], initialSupply: bigint, owner: TAddress): Promise<TxWriter> {
    ...
    $call () {
        return super.$call() as IERC777PresetFixedSupplyTxCaller;
    }
    $signed (): TOverrideReturns<IERC777PresetFixedSupplyTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
        return super.$signed() as any;
    }
    $data (): IERC777PresetFixedSupplyTxData {
        return super.$data() as IERC777PresetFixedSupplyTxData;
    }
    $gas (): TOverrideReturns<IERC777PresetFixedSupplyTxCaller, Promise<{ gas?: bigint, price?: bigint, error?: Error & { data?: { type: string, params } } }>> {
        return super.$gas() as any;
    }

    onTransaction <TMethod extends keyof TERC777PresetFixedSupplyTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TERC777PresetFixedSupplyTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TERC777PresetFixedSupplyTypes = {
    Events: {
        Approval: {
...
interface IERC777PresetFixedSupplyTxCaller {
...
interface IERC777PresetFixedSupplyTxData {
...
type TEvents = TERC777PresetFixedSupplyTypes['Events'];
