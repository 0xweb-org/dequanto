...
export class IERC1822Proxiable extends ContractBase {
    ...
    Types: TIERC1822ProxiableTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/IERC1822Proxiable.ts"
    }
    ...
    $signed (): TOverrideReturns<IIERC1822ProxiableTxCaller, Promise<{ signed: TEth.Hex, error?: Error & { data?: { type: string, params } } }>> {
    ...
    onTransaction <TMethod extends keyof TIERC1822ProxiableTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TIERC1822ProxiableTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TIERC1822ProxiableTypes = {
    Events: {
...
type TEvents = TIERC1822ProxiableTypes['Events'];
