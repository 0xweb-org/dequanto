...
export class IERC721Metadata extends ContractBase {
    ...
    Types: TIERC721MetadataTypes;

    $meta = {
        "class": "./src/prebuilt/openzeppelin/IERC721Metadata.ts"
    }
    ...
    onTransaction <TMethod extends keyof TIERC721MetadataTypes['Methods']> (method: TMethod, options: Parameters<ContractBase['$onTransaction']>[0]): SubjectStream<{
        tx: TEth.Tx
        block: TEth.Block<TEth.Hex>
        calldata: {
            method: TMethod
            arguments: TIERC721MetadataTypes['Methods'][TMethod]['arguments']
        }
    }> {
        options ??= {};
        options.filter ??= {};
...
export type TIERC721MetadataTypes = {
    Events: {
        Approval: {
...
type TEvents = TIERC721MetadataTypes['Events'];
